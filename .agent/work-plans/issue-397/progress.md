...
- [ ] (must-fix 3) Legacy refusals bypassed through a symlink -- **BLOCKED, not changed.** See "Blocked" below.
...
- [ ] (suggestion 1) Snakefile creates `.regenerate/` before any legacy refusal -- **BLOCKED** with must-fix 3.
