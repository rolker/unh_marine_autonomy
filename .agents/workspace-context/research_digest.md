...
- NBS bakes one winner per cell (coverage → uncertainty → age decay; no public formula; supersession unpublished). Its criteria become a documented consumer default, not a store rule.
